...
/**
 *
 * @ClassName: SysSystemMessage
 * @Description: 系统消息-实体对象
 * @author xsk
 */
@Data
@Schema(name = "SysSystemMessage", description = "系统消息")
@TableName("sys_system_message")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class SysSystemMessage implements Serializable{
...
private static final long serialVersionUID = 1L;
    ...
    private String  systemMessagePicture;
    ...
    @TableField(exist = false)
    private List<SysSystemMessageReceive> sysSystemMessageReceiveList;
}