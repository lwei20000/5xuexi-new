package com.struggle.common.core.exception;
...
public class GlobalExceptionHandler {
    ...
    public ApiResult<?> methodNotSupportedExceptionHandler(HttpRequestMethodNotSupportedException e,
        ...
        return new ApiResult<>(Constants.RESULT_ERROR_CODE, "请求方式不正确").setError("methodNotSupportedExceptionHandler");
    }
    ...
    public ApiResult<?> accessDeniedExceptionHandler(AccessDeniedException e, HttpServletResponse response) {
        CommonUtil.addCrossHeaders(response);
        return new ApiResult<>(Constants.UNAUTHORIZED_CODE, Constants.UNAUTHORIZED_MSG).setError("accessDeniedExceptionHandler");
    }
    ...
    public ApiResult<?> businessExceptionHandler(BusinessException e, HttpServletResponse response) {
        CommonUtil.addCrossHeaders(response);
        return new ApiResult<>(e.getCode(), e.getMessage()).setError("businessExceptionHandler");
    }
    ...
    public ApiResult<?> exceptionHandler(Throwable e, HttpServletResponse response) {
        ...
        CommonUtil.addCrossHeaders(response);
        return new ApiResult<>(Constants.RESULT_ERROR_CODE, Constants.RESULT_ERROR_MSG).setError("exceptionHandler");
    }
}
