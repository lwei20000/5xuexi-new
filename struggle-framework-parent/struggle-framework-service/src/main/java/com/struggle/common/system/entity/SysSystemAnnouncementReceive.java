...
/**
 *
 * @ClassName: SysSystemAnnouncementReceive
 * @Description: 系统通知公告接收对象-实体对象
 * @author xsk
 */
@Data
@Schema(name = "SysSystemAnnouncementReceive", description = "系统通知公告接收对象")
@TableName("sys_system_announcement_receive")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class SysSystemAnnouncementReceive implements Serializable{
