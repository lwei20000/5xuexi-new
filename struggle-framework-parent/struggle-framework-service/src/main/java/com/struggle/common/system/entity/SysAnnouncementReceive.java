 ...
 * @Description: 通知公告接收对象-实体对象
 * @author xsk
 */
@Data
@Schema(name = "SysAnnouncementReceive", description = "通知公告接收对象")
@TableName("sys_announcement_receive")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class SysAnnouncementReceive implements Serializable{
