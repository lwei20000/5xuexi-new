...
/**
 *
 * @ClassName: SysSystemMessageReceiveParam
 * @Description: 系统消息接收对象-Param对象
 * @author xsk
 */
@Data
@Schema(description = "系统消息接收对象Param对象")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class SysSystemMessageReceiveParam extends BaseParam  implements Serializable{
