 ...
 * under the License.
 */
package com.struggle.common.client.authentication;
/**
 ...
 * each request. The org.jasig.cas.org.jasig.cas.client will ultimately invoke the {@link #matches(String)} method
 * having already applied and set the pattern via the {@link #setPattern(String)} method.
 * The pattern itself will be retrieved via the org.jasig.cas.org.jasig.cas.client configuration.
