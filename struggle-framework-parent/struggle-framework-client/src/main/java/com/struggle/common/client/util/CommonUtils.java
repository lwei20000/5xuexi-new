...
import com.struggle.common.client.validation.ProxyList;
import com.struggle.common.client.validation.ProxyListEditor;
...
public final class CommonUtils {
    ...
    public static String constructServiceUrl(final HttpServletRequest request, final HttpServletResponse response,
                                             ...
                                             final String artifactParameterName, final boolean encode) {
        return constructServiceUrl(request, response, service, serverNames, serviceParameterName, artifactParameterName, encode, true);
    }

    public static String constructServiceUrl(final HttpServletRequest request, final HttpServletResponse response,
                                             final String service, final String serverNames, final String serviceParameterName,
                                             final String artifactParameterName, final boolean encode, final boolean autoSetPort) {
        ...
        if (builder.getPort() == -1 && !requestIsOnStandardPort(request) && autoSetPort) {
