 ...
 * under the License.
 */
package com.struggle.common.client.jaas;
...
import com.struggle.common.client.authentication.SimpleGroup;
import com.struggle.common.client.authentication.SimplePrincipal;
import com.struggle.common.client.validation.Assertion;
import com.struggle.common.client.validation.TicketValidator;
 ...
 * <pre>
 * cas {
 *   CasLoginModule required
 *     ticketValidatorClass="org.jasig.cas.ai.wiseloong.uaap.client.validation.Saml11TicketValidator"
