 ...
 * under the License.
 */
package com.struggle.common.client.util;

import com.struggle.common.client.configuration.ConfigurationKey;
 ...
 * <ul>
 * <li><code>serverName</code> - the name of the CAS org.jasig.cas.org.jasig.cas.client server, in the format: localhost:8080 or localhost:8443 or localhost or https://localhost:8443</li>
...
public abstract class AbstractCasFilter extends AbstractConfigurationFilter {
    ...
    public final void init(final FilterConfig filterConfig) throws ServletException {
        ...
        if (!isIgnoreInitConfiguration()) {
            ...
            setAutoSetPort(getBoolean(new ConfigurationKey<>("autoSetPort", Boolean.TRUE)));
    ...
    protected final String constructServiceUrl(final HttpServletRequest request, final HttpServletResponse response) {
        return CommonUtils.constructServiceUrl(request, response, this.service, this.serverName,
                ...
                this.protocol.getArtifactParameterName(), this.encodeServiceUrl, this.autoSetPort);
    }
    ...
    public void setAutoSetPort(boolean autoSetPort) {
        this.autoSetPort = autoSetPort;
    }
