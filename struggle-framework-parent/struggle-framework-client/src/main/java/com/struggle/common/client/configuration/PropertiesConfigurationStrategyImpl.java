...
public final class PropertiesConfigurationStrategyImpl extends BaseConfigurationStrategy {
    ...
    /**
     * Property name we'll use in the {@link FilterConfig} and {@link javax.servlet.ServletConfig} to try and find where
     ...
     */
    private static final String DEFAULT_CONFIGURATION_FILE_LOCATION = "/etc/java-cas-org.jasig.cas.ai.wiseloong.uaap.client.properties";
    ...
    public void init(final FilterConfig filterConfig, final Class<? extends Filter> filterClazz) {
        ...
        if (!filterConfigFileLoad) {
            ...
            if (!servletContextFileLoad) {
                ...
                CommonUtils.assertTrue(defaultConfigFileLoaded, "unable to load properties to configure CAS org.jasig.cas.org.jasig.cas.client");
            }
        }
    }
