        ...
        <div class="article-list-wrapper">
          <div class="article-list-left">
            ...
            <div class="article-list-user-group">
              <el-tag effect="plain" size="mini" type="danger" v-if="item.systemAnnouncementType">{{item.systemAnnouncementType}}</el-tag> <span>{{ item.createTime }}</span>
            </div>
          </div>
          <div class="article-list-right">
            <img  v-if="item.systemAnnouncementPicture" :src="item.systemAnnouncementPicture"/>
...
<script>
  import {_pageSystemAnnouncements} from "@/api/system/system-announcement";
  ...
  export default {
    ...
    methods: {
      ...
      query() {
        ...
        _pageSystemAnnouncements(params).then((result) => {
