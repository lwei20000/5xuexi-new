<template>
  <div class="infinite-list-wrapper">
    ...
    <div class="article-list-item" v-for="(item, index) in data" :key="index" @click="gotoSystemMessageDetail(item)">
      ...
      <div class="article-list-wrapper">
        ...
        <div class="article-list-right">
          <img  v-if="item.systemMessagePicture" :src="item.systemMessagePicture"/>
...
<script>
import {_pageSystemMessages,_DetailSystemMessage} from "@/api/system/system-message";
...
export default {
  ...
  methods: {
    ...
    query() {
      ...
      _pageSystemMessages(params).then((result) => {
